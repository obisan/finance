...
class Setting(Enum):
    ...
    CME_PRODUCT_URL_EUR = "CME_PRODUCT_URL_EUR"
    CME_PRODUCT_URL_AUD = "CME_PRODUCT_URL_AUD"
    CME_PRODUCT_URL_JPY = "CME_PRODUCT_URL_JPY"
    CME_PRODUCT_URL_GBP = "CME_PRODUCT_URL_GBP"
    CME_PRODUCT_URL_CHF = "CME_PRODUCT_URL_CHF"
    CME_PRODUCT_URL_CAD = "CME_PRODUCT_URL_CAD"
